    ...
    public void run() {
        try {
            ...
            synchronized (clientMap) {
                ...
                // Send the current list of connected users to the new client so it adds them to the user list
                for (String existingNick : clientMap.keySet()) {
                    if (!existingNick.equals(nick)) { // dont send him his own name
                        clientSocket.print(existingNick + " has joined the chat.\n");
                    }
                }
